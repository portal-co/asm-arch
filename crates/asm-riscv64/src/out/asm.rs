    ...
    ($($ty:ty),*) => {
        const _: () = {
            ...
            impl $crate::out::WriterCore for $ty{
                ...
                fn lw(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), mem: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                    let mem = mem.mem_display(cfg.into());
                    $crate::__::core::write!(self,"lw {dest}, {mem}\n")
                }
                
                fn sw(&mut self, cfg: $crate::RiscV64Arch, src: &(dyn $crate::out::arg::MemArg + '_), mem: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let src = src.mem_display(cfg.into());
                    let mem = mem.mem_display(cfg.into());
                    $crate::__::core::write!(self,"sw {src}, {mem}\n")
                }
                
                fn lb(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), mem: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                    let mem = mem.mem_display(cfg.into());
                    $crate::__::core::write!(self,"lb {dest}, {mem}\n")
                }
                
                fn sb(&mut self, cfg: $crate::RiscV64Arch, src: &(dyn $crate::out::arg::MemArg + '_), mem: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let src = src.mem_display(cfg.into());
                    let mem = mem.mem_display(cfg.into());
                    $crate::__::core::write!(self,"sb {src}, {mem}\n")
                }
                
                fn lh(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), mem: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                    let mem = mem.mem_display(cfg.into());
                    $crate::__::core::write!(self,"lh {dest}, {mem}\n")
                }
                
                fn sh(&mut self, cfg: $crate::RiscV64Arch, src: &(dyn $crate::out::arg::MemArg + '_), mem: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let src = src.mem_display(cfg.into());
                    let mem = mem.mem_display(cfg.into());
                    $crate::__::core::write!(self,"sh {src}, {mem}\n")
                }
                
                fn jalr(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), base: &(dyn $crate::out::arg::MemArg + '_), offset: i32) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                    let base = base.mem_display(cfg.into());
                    $crate::__::core::write!(self,"jalr {dest}, {base}, {offset}\n")
                }
                
                fn jal(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), target: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                    let target = target.mem_display(cfg.into());
                    $crate::__::core::write!(self,"jal {dest}, {target}\n")
                }
                
                fn beq(&mut self, cfg: $crate::RiscV64Arch, a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_), target: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                ...
                fn bne(&mut self, cfg: $crate::RiscV64Arch, a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_), target: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let a = a.mem_display(cfg.into());
                    let b = b.mem_display(cfg.into());
                    let target = target.mem_display(cfg.into());
                ...
                fn blt(&mut self, cfg: $crate::RiscV64Arch, a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_), target: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let a = a.mem_display(cfg.into());
                    let b = b.mem_display(cfg.into());
                    let target = target.mem_display(cfg.into());
                ...
                fn bge(&mut self, cfg: $crate::RiscV64Arch, a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_), target: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let a = a.mem_display(cfg.into());
                    let b = b.mem_display(cfg.into());
                    let target = target.mem_display(cfg.into());
                ...
                fn bltu(&mut self, cfg: $crate::RiscV64Arch, a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_), target: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let a = a.mem_display(cfg.into());
                    let b = b.mem_display(cfg.into());
                    let target = target.mem_display(cfg.into());
                ...
                fn bgeu(&mut self, cfg: $crate::RiscV64Arch, a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_), target: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let a = a.mem_display(cfg.into());
                    let b = b.mem_display(cfg.into());
                    let target = target.mem_display(cfg.into());
                ...
                fn sra(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                    let a = a.mem_display(cfg.into());
                    let b = b.mem_display(cfg.into());
                ...
                fn slt(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                    let a = a.mem_display(cfg.into());
                    let b = b.mem_display(cfg.into());
                ...
                fn sltu(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                    let a = a.mem_display(cfg.into());
                    let b = b.mem_display(cfg.into());
                ...
                fn addi(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), src: &(dyn $crate::out::arg::MemArg + '_), imm: i32) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                    let src = src.mem_display(cfg.into());
                    $crate::__::core::write!(self,"addi {dest}, {src}, {imm}\n")
                }
                
                fn lui(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), imm: u32) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                    $crate::__::core::write!(self,"lui {dest}, {imm}\n")
                }
                
                fn auipc(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), imm: u32) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                ...
                fn call(&mut self, cfg: $crate::RiscV64Arch, target: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let target = target.mem_display(cfg.into());
                    $crate::__::core::write!(self,"call {target}\n")
                }
                
                fn j(&mut self, cfg: $crate::RiscV64Arch, target: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let target = target.mem_display(cfg.into());
                ...
                fn mulh(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                    let a = a.mem_display(cfg.into());
                    let b = b.mem_display(cfg.into());
                ...
                fn divu(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                    let a = a.mem_display(cfg.into());
                    let b = b.mem_display(cfg.into());
                ...
                fn rem(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                    let a = a.mem_display(cfg.into());
                    let b = b.mem_display(cfg.into());
                ...
                fn remu(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let dest = dest.mem_display(cfg.into());
                    let a = a.mem_display(cfg.into());
                    let b = b.mem_display(cfg.into());
                ...
                // F/D extension
                fn fld(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), mem: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                ...
                fn fsd(&mut self, cfg: $crate::RiscV64Arch, src: &(dyn $crate::out::arg::MemArg + '_), mem: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let opts = $crate::DisplayOpts::with_reg_class(cfg, $crate::RegisterClass::Fp);
                ...
                fn fadd_d(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let opts = $crate::DisplayOpts::with_reg_class(cfg, $crate::RegisterClass::Fp);
                    let dest = dest.mem_display(opts);
                ...
                fn fsub_d(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let opts = $crate::DisplayOpts::with_reg_class(cfg, $crate::RegisterClass::Fp);
                    let dest = dest.mem_display(opts);
                    let a = a.mem_display(opts);
                    let b = b.mem_display(opts);
                ...
                fn fmul_d(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let opts = $crate::DisplayOpts::with_reg_class(cfg, $crate::RegisterClass::Fp);
                    let dest = dest.mem_display(opts);
                    let a = a.mem_display(opts);
                    let b = b.mem_display(opts);
                ...
                fn fdiv_d(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let opts = $crate::DisplayOpts::with_reg_class(cfg, $crate::RegisterClass::Fp);
                    let dest = dest.mem_display(opts);
                    let a = a.mem_display(opts);
                    let b = b.mem_display(opts);
                ...
                fn fmov_d(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), src: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let opts = $crate::DisplayOpts::with_reg_class(cfg, $crate::RegisterClass::Fp);
                    let dest = dest.mem_display(opts);
                    let src = src.mem_display(opts);
                ...
                fn fcvt_d_l(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), src: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                ...
                fn fcvt_l_d(&mut self, cfg: $crate::RiscV64Arch, dest: &(dyn $crate::out::arg::MemArg + '_), src: &(dyn $crate::out::arg::MemArg + '_)) -> Result<(), Self::Error>{
                    let opts_fp = $crate::DisplayOpts::with_reg_class(cfg, $crate::RegisterClass::Fp);
                    let opts_gpr = $crate::DisplayOpts::new(cfg);
            ...
            impl<L: Display, Context> $crate::out::Writer<L, Context> for $ty {
                ...
                fn bcond_label(&mut self, cfg: $crate::RiscV64Arch, cond: $crate::ConditionCode, a: &(dyn $crate::out::arg::MemArg + '_), b: &(dyn $crate::out::arg::MemArg + '_), label: L) -> Result<(),Self::Error>{
                    let a = a.mem_display(cfg.into());
                    let b = b.mem_display(cfg.into());
                    match cond {
